...
#[test]
fn dummy() -> Result<()> {
    let mut contract = Contract::new(Test::CALL_DUMMY).pure().compile()?;
...
#[test]
fn params() -> Result<()> {
    let mut contract = Contract::new(Test::CALL_PARAMS).pure().compile()?;
...
#[test]
fn as_if() -> Result<()> {
    let mut contract = Contract::new(Test::CALL_AS_IF).pure().compile()?;
