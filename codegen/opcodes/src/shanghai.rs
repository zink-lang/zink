...
opcodes! {
    ...
    (0x10, LT, 3, 2, 1, "Less-than comparision.", Frontier, ComparisonBitwiseLogic),
    (0x11, GT, 3, 2, 1, "Greater-than comparision.", Frontier, ComparisonBitwiseLogic),
    (0x12, SLT, 3, 2, 1, "Signed less-than comparision.", Frontier, ComparisonBitwiseLogic),
    (0x13, SGT, 3, 2, 1, "Signed greater-than comparision.", Frontier, ComparisonBitwiseLogic),
    (0x14, EQ, 3, 2, 1, "Equality comparision.", Frontier, ComparisonBitwiseLogic),
    ...
    (0x40, BLOCKHASH, 20, 1, 1, "Get the hash of one of the 256 most recent complete blocks.", Frontier, BlockInformation),
    ...
    (0x58, PC, 2, 0, 1, "Get the value of the program counter prior to the increment corresponding to this instruction.", Frontier, StackMemoryStorageFlow),
    (0x59, MSIZE, 2, 0, 1, "Get the size of active memory in bytes.", Frontier, StackMemoryStorageFlow),
    (0x5a, GAS, 2, 0, 1, "Get the amount of available gas, including the corresponding reduction the amount of available gas.", Frontier, StackMemoryStorageFlow),
    ...
    (0xf0, CREATE, 32000, 3, 1, "Create a new account with associated", Frontier, System),
    (0xf1, CALL, 40, 7, 1, "Message-call into an account.", Frontier, System),
    (0xf2, CALLCODE, 40, 7, 1, "Message-call into this account with alternative account’s code.", Frontier, System),
    (0xf3, RETURN, 0, 2, 0, "Halt execution returning output data.", Frontier, System),
    (0xf4, DELEGATECALL, 40, 6, 1, "Message-call into this account with an alternative account’s code, but persisting into this account with an alternative account’s code, but persisting into this account’s storage and context.", Frontier, System),
    ...
    (0xfd, REVERT, 0, 2, 0, "Stop execution and revert state changes, without consuming all provided gas and providing a reason.", Byzantium, System),
